...
public class SysOpEnvironment implements EnvironmentInterface {
	...
	//Specify that there will be couple of boolean observations for the cpus.
    ...
    public Reward_observation_terminal env_step(Action thisAction) {
        ...
        //Calculate next state ("cpus" contains the previous state, "nextCpuList" 
        ...
        for(SysOpCpu c : nextCpuList) {
        	if (c.getId() == rebooted) {
	        	...
	        	//All cpus that are down can affect neighboring cpus to come down
   ...
   /**
    ...
    public static void main(String[] args){
        EnvironmentLoader theLoader=new EnvironmentLoader(new SysOpEnvironment());
        theLoader.run();
    }
